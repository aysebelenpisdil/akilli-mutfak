...
class AuthService:
    ...
    async def generate_magic_link(self, user_id: str) -> str:
        ...
        expires_at = datetime.now(timezone.utc).replace(tzinfo=None) + timedelta(seconds=settings.MAGIC_LINK_EXPIRY)
    ...
    async def create_session(self, user_id: str) -> str:
        ...
        expires_at = datetime.now(timezone.utc).replace(tzinfo=None) + timedelta(days=settings.SESSION_EXPIRY_DAYS)
